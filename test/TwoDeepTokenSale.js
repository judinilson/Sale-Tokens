var TwoDeepTokenSale = artifacts.require("./TwoDeepTokenSale");
var TwoDeepToken = artifacts.require("./TwoDeepToken");
contract("TwoDeepTokenSale", function (accounts) {
  var tokenInstance;
  ...
  it("initializes the contract with the correct values", function () {
    return TwoDeepTokenSale.deployed()
  ...
  it("facilitaty token buying", function () {
